    ...
    <div className="app">
      <div className="profile-card">
        ...
        <div className="card-body">
          <h1 className="name">Paul Charles P. Aleria</h1>
          <p className="title">Information Technology Student</p>
          ...
          <div className="stats">
            ...
            <div className="stat">
              <span className="stat-icon">🔄</span>
              <span className="stat-number">USTP</span>
            </div>
          </div>
          
          <div className="bio">
            <p>Hi! I'm a 23-year-old second-year BS Information Technology student at USTP in Cagayan de Oro City. I serve as the SK Treasurer in Purok 4, Barangay Puerto.</p>
          </div>
        </div>
      </div>
    </div>
